          ...
          <CommandList className="scrollbar-visible max-h-[200px] overflow-auto md:max-h-[300px]">
            ...
            {!!value && unset && (
              <CommandGroup>
                ...
                >
                  <p className="text-[#5C5147]">Select Superteam</p>
                </CommandItem>
              </CommandGroup>
            )}
            {showGlobal && (
            ...
            {showNoAssociation && (
              <CommandItem
                ...
                className={cn(
                  'cursor-pointer',
                  value === 'No association' && 'bg-[#C4502E]/25',
                )}
              >
                <p className="pl-3 text-sm text-[#221A14]">No association</p>
              </CommandItem>
            )}
          </CommandList>
          {!isMD && (
            <CommandInput
              placeholder="Search..."
              wrapperClassName="border-b-0 border-t border-[#E6DCC9]"
            />
          )}
        </Command>
      </PopoverContent>
