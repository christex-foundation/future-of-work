...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        'text-muted-foreground inline-flex h-9 items-center justify-center rounded-none p-1',
        className,
      )}
      {...props}
    />
...
function TabsTrigger({
  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        'group ring-offset-background data-[state=active]:text-brand-purple relative inline-flex items-center justify-center rounded-none px-3 py-1 text-xs font-medium whitespace-nowrap transition-all sm:text-sm',
