...
export const DeleteDraftModal = ({
  ...
  return (
    <Dialog open={deleteDraftIsOpen} onOpenChange={deleteDraftOnClose}>
      <DialogContent
        className="m-0 border-[#E6DCC9] bg-[#FFFDF8] p-0 text-[#221A14]"
        hideCloseIcon
      >
        <DialogTitle className="text-md -mb-1 px-6 pt-4 font-semibold text-[#221A14]">
          Delete Draft?
        </DialogTitle>
        <Separator className="bg-[#E6DCC9]" />
        <div className="px-6 pb-6 text-[0.95rem]">
          <p className="mb-4 text-[#5C5147]">
